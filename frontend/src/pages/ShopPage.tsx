...
function ShopItemCard({
  ...
  if (item.item_type === 'physical') {
    return (
      <div className="bg-dark-700 border border-gray-600 rounded-xl p-5 flex flex-col gap-3">
            ...
            {activeTab === 'physical' && (
              <div>
                <div className="bg-green-900/20 border border-green-700 rounded-xl px-5 py-4 mb-6 text-sm text-green-300">
                  ...
                  <br />
                  Ces produits sont offerts <strong>gratuitement</strong> lors de
                  nos soirées événement. Pas de pièces requises — il suffit d'être
