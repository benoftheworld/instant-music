...
class UserAdmin(BaseUserAdmin):
    ...
    def coins_display(self, obj):
        """Affiche le solde de pièces de l'utilisateur."""
        return format_html(
...
class FriendshipAdmin(admin.ModelAdmin):
    ...
    def status_badge(self, obj):
        """Affiche le statut de l'amitié avec un badge coloré."""
        colors = {
            "pending": "#3b82f6",
            "accepted": "#10b981",
            "rejected": "#ef4444",
...
class TeamMemberInline(admin.TabularInline):
    """Admin inline pour les membres d'une équipe."""
...
class TeamAdmin(admin.ModelAdmin):
    ...
    def member_count(self, obj):
        """Affiche le nombre de membres dans l'équipe."""
        return obj.memberships.count()


@admin.register(TeamJoinRequest)
class TeamJoinRequestAdmin(admin.ModelAdmin):
    """Admin interface for TeamJoinRequest model."""
    ...
    @admin.display(description=_("Statut"))
    def status_badge(self, obj):
        """Affiche le statut de la demande d'adhésion avec un badge coloré."""
        colors = {
            "pending": "#3b82f6",
            "approved": "#10b981",
            "rejected": "#ef4444",
