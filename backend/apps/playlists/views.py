...
class PlaylistViewSet(viewsets.ViewSet):
    ...
    @action(detail=False, methods=['get'], url_path='(?P<playlist_id>[^/.]+)')
    ...
    @action(detail=False, methods=['get'], url_path='(?P<playlist_id>[^/.]+)/tracks')
    ...
    @action(detail=False, methods=['get'], url_path='(?P<playlist_id>[^/.]+)/validate')
