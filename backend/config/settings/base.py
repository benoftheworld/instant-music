...
JAZZMIN_UI_TWEAKS = {
    ...
    "theme": "default",
    # 'dark_mode_theme' is deprecated in newer Jazzmin versions;
    # use 'default_theme_mode' with values 'auto'|'light'|'dark'.
...
JWT_REFRESH_COOKIE_SECURE = not DEBUG  # True en prod (HTTPS), False en dev
